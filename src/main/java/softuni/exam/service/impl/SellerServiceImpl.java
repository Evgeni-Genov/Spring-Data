...
public class SellerServiceImpl implements SellerService {
    private static final String SELLERS_FILE_DIRECTORY = "src/main/resources/files/xml/sellers.xml";
    ...
    public String readSellersFromFile() throws IOException {
        return Files.readString(Path.of(SELLERS_FILE_DIRECTORY));
    }

    @Override
    public String importSellers() throws IOException, JAXBException {
        SellerSeedRootDto sellerSeedRootDto = xmlParser.fromFile(SELLERS_FILE_DIRECTORY, SellerSeedRootDto.class);
        ...
        sellerSeedRootDto.getSellers()
                .stream().filter(sellerSeedDto -> {
                    ...
                    sb.append(isValid ? String.format("Successfully import seller Juanes - %s",
